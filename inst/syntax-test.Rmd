...
One feature in pandoc highlighting but not in RStudio highlighting of escape 
sequences. 
...
Based on my tests, two things that currently not correct with the default
definition and my definition are the native pipe, lambda syntax, and imaginary
numbers.
...
My wishlist for the definition is namespace highlighting. It would 
be cool for package names to be highlighted and italicized.
