...
Based on my tests, three things that are currently not correct with the default
...
My wishlist for a language definition for syntax highlighting is namespace
highlighting. It would be cool for package names to be highlighted and
italicized.
